...
Engine::Engine() {
  ...
  app->init(this);
  this->cam.init(60, 0.0001, 100000, glm::vec3(-40, 20, 30));
  this->add_shader(camera_vs, basic_fs, "");
  this->add_shader(camera_vs, cool_fs, "");
  ...
  Material mat;
  mat.init(this->get_shader(0).value());
  // TODO: Change this texture
  Texture tex("face.png");
  cout << tex.get_id() << endl;
